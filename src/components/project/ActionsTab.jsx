    ...
    return (
        <div className="max-w-5xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-lg font-semibold text-[var(--color-brand-primary)]">Open Actions</h2>
                <div className="flex gap-2">
                    ...
                    <button className="btn btn-outline text-sm">Download List</button>
                </div>
            </div>
            ...
            {showForm && (
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6 animate-in slide-in-from-top-2">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="font-bold text-gray-700 text-sm">Adding New Action Item</h3>
